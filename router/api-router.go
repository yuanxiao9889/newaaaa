...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		tokenRoute.Use(middleware.UserAuth())
		{
			...
			tokenRoute.GET("/usage", controller.GetTokenUsagePeriodStats)
		...
		{
			profitRoute.GET("/password/status", controller.GetProfitPasswordStatus)
			profitRoute.POST("/password", controller.SetProfitPassword)
			profitRoute.POST("/verify", controller.VerifyProfitPassword)

			protectedProfitRoute := profitRoute.Group("/")
			protectedProfitRoute.Use(middleware.ProfitVerificationRequired())
			{
				protectedProfitRoute.GET("/summary", controller.GetProfitSummary)
				protectedProfitRoute.GET("/breakdown", controller.GetProfitBreakdown)
				protectedProfitRoute.GET("/cost-prices", controller.ListProfitCostPrices)
				protectedProfitRoute.GET("/cost-price-prefill", controller.GetProfitCostPricePrefill)
				protectedProfitRoute.POST("/cost-prices", controller.SaveProfitCostPrice)
				protectedProfitRoute.DELETE("/cost-prices/:id", controller.DeleteProfitCostPrice)
			}
		}
		...
		{
			taskRoute.GET("/self/:id", middleware.UserAuth(), controller.GetUserTaskDetail)
			taskRoute.GET("/self", middleware.UserAuth(), controller.GetUserTask)
			taskRoute.GET("/:id", middleware.AdminAuth(), controller.GetTask)
